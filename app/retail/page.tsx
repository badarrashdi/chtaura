    ...
    <section className="py-20 md:py-28">
      <div className="container">
        ...
        <div className="grid md:grid-cols-2 gap-8 mt-20">
          <motion.img initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }} src="/assets/olive-oil.jpg" alt="Olive oil tasting" loading="lazy" width={1200} height={1500} className="w-full h-[480px] object-cover" />
          <motion.img initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8, delay: 0.15 }} src="/assets/pasta.jpg" alt="Artisan pasta" loading="lazy" width={1200} height={1500} className="w-full h-[480px] object-cover" />
        </div>
      </div>
    </section>
  </>
